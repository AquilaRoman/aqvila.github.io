...
function writeForm() {
	...
	writing += `<div class="text-tabs">
					<textarea class="form-control" name="message" rows="5" cols="40" id="message" placeholder="Write a message to contact me..." maxlength="300">
					</textarea>
